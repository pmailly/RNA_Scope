 ...
 * Modified by phm 20/10/2020
 * remove display of resulting image
 */
...
public class CellOutliner  {
  ...
  private boolean processAllFrames = true;
  public static boolean processAllSlices = true;
  ...
  public int cellRadius = 25;
  public double tolerance = 0.8;
  public boolean darkEdge = true;
  public int kernelWidth = 13;
  public double kernelSmoothing = 1;
  public int polygonSmoothing = 1;
  public double weightingGamma = 3;
  public int iterations = 3;
  public boolean ellipticalFit = false;
  public int dilate = 0;
  ...
  /** {@inheritDoc} */
  public ImagePlus run(ImageProcessor inputProcessor) {
  ...
  private PolygonRoi[] findCells(ImageProcessor inputProcessor) {
    ...
    for (int n = 0; n < xpoints.length; n++) {
      ...
      double[] params = {cx - pointBounds.x, cy - pointBounds.y, cellRadius,
  ...
  private int getCellRange() {
    return (int) Math.ceil(
        cellRadius + cellRadius * tolerance + kernelWidth / 2);
  }
