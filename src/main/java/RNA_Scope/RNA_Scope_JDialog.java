...
public class RNA_Scope_JDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextFieldImagesFolder.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldImagesFolderActionPerformed(evt);
            }
        });
        jTextFieldImagesFolder.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                jTextFieldImagesFolderPropertyChange(evt);
            }
        });
        ...
        jComboBoxDAPICh.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jComboBoxDAPIChItemStateChanged(evt);
            }
        });
        ...
        jComboBoxGeneRefCh.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jComboBoxGeneRefChItemStateChanged(evt);
            }
        });
        ...
        jComboBoxGeneXCh.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jComboBoxGeneXChItemStateChanged(evt);
            }
        });
    ...
    private void jTextFieldImagesFolderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldImagesFolderActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldImagesFolderActionPerformed

    private void jTextFieldImagesFolderPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jTextFieldImagesFolderPropertyChange
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldImagesFolderPropertyChange
    ...
    private void jComboBoxDAPIChItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxDAPIChItemStateChanged
        // TODO add your handling code here:
        if (jComboBoxDAPICh.getItemCount() != 0)
            rna.channels.add(0, jComboBoxDAPICh.getSelectedItem().toString());
    }//GEN-LAST:event_jComboBoxDAPIChItemStateChanged
    ...
    private void jComboBoxGeneXChItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxGeneXChItemStateChanged
        // TODO add your handling code here:
        if (jComboBoxGeneXCh.getItemCount() != 0)
            rna.channels.add(2, jComboBoxGeneXCh.getSelectedItem().toString());
    }//GEN-LAST:event_jComboBoxGeneXChItemStateChanged
    ...
    private void jComboBoxGeneRefChItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBoxGeneRefChItemStateChanged
        // TODO add your handling code here:
        if (jComboBoxGeneRefCh.getItemCount() != 0)
            rna.channels.add(1, jComboBoxGeneRefCh.getSelectedItem().toString());
    }//GEN-LAST:event_jComboBoxGeneRefChItemStateChanged
